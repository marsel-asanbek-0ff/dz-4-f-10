function classListItems(html) {
    var Div = document.createElement('div');
    Div.innerHTML = html;
  
    var listItems = Div.querySelectorAll('.list-item');
    var classValues = [];
  
    for (var i = 0; i < listItems.length; i++) {
      var listItem = listItems[i];
      classValues.push(listItem.getAttribute('class'));
    }
  ...
  var result = classListItems(htmlCode);
  console.log(result);
